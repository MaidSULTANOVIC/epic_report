            ...
            IntrinsicHeight(
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Text(controller.calculateSpeed(index, 0) + " SPD"),
                      Text(controller.determineHP(index, 0)),
                    ],
                  ),
                ],
              ),
                                ...
                                children: [
                                  Flexible(
                                    child: Container(
                                        ...
                                        child: TextFormField(
                                          onChanged: (value) {
                                            controller.changeName(value, index);
                                          },
                                          initialValue:
                                              controller.name[index].text,
                                          decoration: InputDecoration(
                                  ...
                                  Flexible(
                                    child: Container(
                                        ...
                                        child: TextFormField(
                                            ...
                                            initialValue:
                                                controller.artifact[index].text,
                                            decoration: InputDecoration(
                                              labelText: 'Artifact',
                                            ),
                                  ...
                                  Flexible(
                                    child: Container(
                                        ...
                                        child: CheckboxListTile(
                                            ...
                                            onChanged: (value) {
                                              setState(() {
                                                controller.checkedValueOutspeed[
                                                    index] = value!;
                                              });
                                            })),
                                  ),
                                  ...
                                  Flexible(
                                    child: Container(
                                        ...
                                        child: CheckboxListTile(
                                            ...
                                            onChanged: (value) {
                                              setState(() {
                                                controller.checkedValueImmunity[
                                                    index] = value!;
                                              });
                                            })),
                                  ),
